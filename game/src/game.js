...
function loadMeta(){try{const j=JSON.parse(localStorage.getItem(SAVE_KEY));if(j&&j.v===2){
  ...
  if(!j.daily)j.daily=null;if(!j.cosmetics)j.cosmetics={owned:['default'],equipped:'default'};if(j.tutorialSeen==null)j.tutorialSeen=false;return j;}}catch(e){}
  return{v:2,credits:0,skills:[],unlockedPlanets:['terra'],planet:'terra',lifetime:0,prestige:{cores:0},
    ...
    cosmetics:{owned:['default'],equipped:'default'},tutorialSeen:false};}
const SKINS=[
...
function applyLang(){
  ...
  set('tutTitle','tutTitle');set('tut1','tut1');set('tut2','tut2');set('tut3','tut3');set('btnTutGo','tutGo');set('btnHelp','help');
...
document.getElementById('btnHelp').onclick=()=>{sfx.ui();show('tutOver');};
